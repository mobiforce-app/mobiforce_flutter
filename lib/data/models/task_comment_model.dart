  ...
  */  return map;
  ...
  factory TaskCommentModel.fromMap(Map<String, dynamic> map)
  {
    ...
    TaskCommentModel comment = TaskCommentModel(
      ...
      //taskField:taskField,
      task:TaskModel(id: map['task_id'], serverId: map['task_external_id'],unreadedCommentCount: 0),//nullTaskModel.fromMap(taskMap: {"external_id":0,"id":0}, statusMap: null),
  ...
  factory TaskCommentModel.fromJson(Map<String, dynamic> json)
  {
    ...
    TaskCommentModel comment =  TaskCommentModel(
      ...
      readedTime: json['readedTime']!=null?int.parse(json['readedTime']??"0"):null,
      dirty: true,
