...
class AddTaskComment extends UseCase<TaskCommentEntity, AddTaskCommentParams>{
  final TaskRepository taskRepository;
  AddTaskComment(this.taskRepository);
  Future<Either<Failure, TaskCommentEntity>> call(AddTaskCommentParams params) async => await taskRepository.addTaskComment(comment:params.comment);
}
