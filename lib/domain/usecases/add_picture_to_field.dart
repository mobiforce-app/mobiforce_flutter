...
class AddPictureToTaskField extends UseCase<FileModel, AddPictureToTaskFieldParams>{
  final TaskRepository taskRepository;
  //final FileRepository fileRepository;
  AddPictureToTaskField({required this.taskRepository});
  Future<Either<Failure, FileModel>> call(AddPictureToTaskFieldParams params) async
  {
...
class AddPictureToTaskFieldParams extends Equatable{
  final int taskFieldId;
  final int pictureId;
  //final PictureParentTypeEnum parent;
  //final int? taskFieldSelectionValue;
  AddPictureToTaskFieldParams({required this.taskFieldId, required this.pictureId});
