...
class AddCommentWithPictureToTask extends UseCase<TaskCommentModel, AddCommentWithPictureToTaskParams>{
  final TaskRepository taskRepository;
  //final FileRepository fileRepository;
  AddCommentWithPictureToTask({required this.taskRepository});
  Future<Either<Failure, TaskCommentModel>> call(AddCommentWithPictureToTaskParams params) async
  {
              ...
              //if(params.parent==PictureParentTypeEnum.taskField) {
                final Either fileOrFairure = await taskRepository
                    .addTaskFieldPicture(
                    taskFieldId: params.taskId, pictureId: params.pictureId);
...
class AddCommentWithPictureToTaskParams extends Equatable{
  final int taskId;
  final int pictureId;
  //final PictureParentTypeEnum parent;
  //final int? taskFieldSelectionValue;
  AddCommentWithPictureToTaskParams({required this.taskId, required this.pictureId});
